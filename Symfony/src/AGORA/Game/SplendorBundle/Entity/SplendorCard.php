...
class SplendorCard
{
     ...
     * @var int
     *
     * @ORM\Column(name="emeraldTokens", type="integer")
     */
     ...
     * @var int
     *
     * @ORM\Column(name="sapphireTokens", type="integer")
     */
     ...
     * @var int
     *
     * @ORM\Column(name="rubyTokens", type="integer")
     */
    private $rubyTokens;
     ...
     * @var int
     *
     * @ORM\Column(name="diamondTokens", type="integer")
     */
     ...
     * @var int
     *
     * @ORM\Column(name="onyxTokens", type="integer")
     */
    private $onyxTokens;
